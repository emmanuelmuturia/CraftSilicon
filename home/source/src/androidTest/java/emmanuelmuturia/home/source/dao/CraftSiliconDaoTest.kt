...
/**
 * This is the Craft Silicon Dao's Test...
 */
...
class CraftSiliconDaoTest {
    ...
    @Test
    fun testInsertAndGetCurrentWeather() =
        runTest {
            // Given the Current City Weather...
            val currentCityWeatherEntity =
    ...
    @Test
    fun testInsertAndGetForecastWeather() =
        runTest {
            ...
            val forecastCityWeatherEntity =
                ForecastCityWeatherEntity(
                    ...
                    list = listOf(),
                    forecastCityEntity =
                        emmanuelmuturia.home.source.local.entity.forecast.ForecastCityEntity(
                            forecastCoordEntity =
